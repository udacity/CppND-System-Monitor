...
bool Process::KeepAlive()
{
  return keepAlive_;
}
void Process::KeepAlive(bool alive)
{
  keepAlive_ = alive;
}
void Process::updateCpuUsage(void)
{
  ...
  cpuUsage_ = (((currentActiveJiffies_ - previousActiveJiffies)/ (currentTotalJiffies_ - previousTotalJiffies)));
}
